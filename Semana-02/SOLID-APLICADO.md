...
|------------|----------------------------------|----------------|----|
| SRP | Cada clase tiene una única responsabilidad: entidad, validación, persistencia o lógica de negocio |``` reserva.js, propiedad.js, reserva-validator.js, memory-repository.js, reserva-service.js``` | ✅ |
